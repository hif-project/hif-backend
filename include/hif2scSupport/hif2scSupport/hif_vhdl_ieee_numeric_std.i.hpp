...
template <int size> bool hif_vhdl__op_eq_unsigned(const hdtlib::hl_lv_t<size> &v1, const hdtlib::hl_bv_t<size> &v2)
{
    if (!v1.is_01())
        return false;
    return v1 == v2;
...
template <int size> bool hif_vhdl__op_eq_unsigned(const hdtlib::hl_bv_t<size> &v1, const hdtlib::hl_lv_t<size> &v2)
{
    if (!v2.is_01())
        return false;
    return v1 == v2;
...
template <int size> bool hif_vhdl__op_eq_unsigned(const hdtlib::hl_bv_t<size> &v1, const hdtlib::hl_bv_t<size> &v2)
{
    return v1 == v2;
}
